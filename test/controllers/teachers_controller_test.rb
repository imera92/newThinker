...
class TeachersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teacher" do
    assert_difference('Teacher.count') do
      post teachers_url, params: { teacher: { email: @teacher.email, password: @teacher.password } }
    end
  ...
  test "should update teacher" do
    patch teacher_url(@teacher), params: { teacher: { email: @teacher.email, password: @teacher.password } }
